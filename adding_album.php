...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
    ...
    // Insert query
    $sql = "INSERT INTO Album (AlbumTitle, ReleaseDateAlbum, ArtistID, LanguageID, ImagePath, ImageData) 
            VALUES ('$album_title', '$release_date', '$artist_id', '$language_id', '$image_path', '$image_data')";

    if ($conn->query($sql) === TRUE) {
        // Redirect to Albums page after successful insertion
...
<head>
    ...
    <title>Add Album - Admin Panel</title>
    <!-- Bootstrap CSS -->
...
<header id="header" class="fixed-top header-inner-pages">
    ...
    <div class="container">
        <div class="form-container">
            <h2 class="form-header">Add Album</h2>
            <form method="post" action="adding_album.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="artist_id" name="artist_id" required>
                        ...
                        <?php
                        // Reset the pointer for artists dropdown
                        $artists->data_seek(0);
                ...
                <button type="submit" class="btn btn-submit" name="submit">Add Album</button>
            </form>
        </div>
    </div>
