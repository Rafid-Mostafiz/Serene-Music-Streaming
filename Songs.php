                    ...
                    <div class="col-md-3 mb-4">
                        <div class="card">
                            <?php if (isset($item['ImageData'])) : ?>
                                ...
                                ?>
                                <a href="song.php?song_id=<?php echo $item['SongID']; ?>">
                                    <img src="<?php echo $imageSrc; ?>" class="card-img-top" alt="<?php echo isset($item['Title']) ? $item['Title'] : ''; ?>">
                                </a>
                            <?php endif; ?>
                            <div class="card-body">
                                <?php if (isset($item['Title'])) : ?>
                                    <h5 class="card-title">
                                        <a href="song.php?song_id=<?php echo $item['SongID']; ?>"><?php echo $item['Title']; ?></a>
                                    </h5>
                                <?php endif; ?>
