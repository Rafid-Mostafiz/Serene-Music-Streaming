...
<head>
    ...
    <title>Syŕene - All Artists</title>
        ...
        <h1 class="logo"><a href="Home_Page.php">Syŕene</a></h1>
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto active" href="Artists.php">Artists</a></li>
            ...
            <div class="row">
                <?php foreach ($data as $item) : ?>
                    <div class="col-md-3 mb-4">
                        <div class="card">
                            <a href="artist1.php?artistId=<?php echo $item['ArtistID']; ?>">
                                <?php if (isset($item['ImageData'])) : ?>
                                    <?php
                                    $imageData = base64_encode($item['ImageData']);
                                    $imageSrc = "data:image/jpeg;base64," . $imageData;
                                    ?>
                                    <img src="<?php echo $imageSrc; ?>" class="card-img-top" alt="<?php echo isset($item['ArtistName']) ? $item['ArtistName'] : ''; ?>">
                                <?php endif; ?>
                                <div class="card-body">
                                    <?php if (isset($item['ArtistName'])) : ?>
                                        <h5 class="card-title"><?php echo $item['ArtistName']; ?></h5>
                                    <?php endif; ?>
